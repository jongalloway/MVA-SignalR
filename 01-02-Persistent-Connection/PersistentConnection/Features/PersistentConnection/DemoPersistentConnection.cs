...
namespace PersistentConnectionDemo.Features.SamplePersistentConnection
{
    ...
    {       
        ...
        protected override Task OnDisconnected(IRequest request, string connectionId, bool stopCalled = true)
        {
